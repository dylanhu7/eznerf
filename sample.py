...
def sample_stratified(rays: torch.Tensor, near=2., far=6., num_samples=64) -> torch.Tensor:
    ...
    Args:
        rays (torch.Tensor): A tensor of rays of shape (image_height, image_width, 3, 2), where the last dimension partitions the origins and directions.
    ...
    Returns:
        torch.Tensor: A tensor of points of shape (image_height, image_width, num_samples, 3).
    """
